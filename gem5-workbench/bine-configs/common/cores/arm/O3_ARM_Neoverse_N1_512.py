...
class O3_ARM_Neoverse_N1_ICache_512(Cache):
    tag_latency = 1
    data_latency = 1
    response_latency = 1
    mshrs = 8
...
class O3_ARM_Neoverse_N1_DCache_512(Cache):
    tag_latency = 3
    data_latency = 3
    response_latency = 1
    tgts_per_mshr = 16
...
class O3_ARM_Neoverse_N1_L2_512(Cache):
    tag_latency = 5
    data_latency = 5
    response_latency = 2 
    mshrs = 46  # (1)
...
class O3_ARM_Neoverse_N1_L3_512(L3Cache):
    tag_latency = 48 
    data_latency = 48
    response_latency = 16 
    assoc = 16 # (1)
...
class O3_ARM_Neoverse_N1_FP_512(FUDesc):
...
class O3_ARM_Neoverse_N1_Simple_Int_512(FUDesc):
...
class O3_ARM_Neoverse_N1_Complex_Int_512(FUDesc):
...
class O3_ARM_Neoverse_N1_LoadStore_512(FUDesc):
...
class O3_ARM_Neoverse_N1_PredAlu_512(FUDesc):
    opList = [ OpDesc(opClass='SimdPredAlu')  ]
    count = 1

class O3_ARM_Neoverse_N1_FUP_512(FUPool):
    FUList = [O3_ARM_Neoverse_N1_Simple_Int_512(),
              O3_ARM_Neoverse_N1_Complex_Int_512(),
              O3_ARM_Neoverse_N1_LoadStore_512(),
              O3_ARM_Neoverse_N1_PredAlu_512(),
              O3_ARM_Neoverse_N1_FP_512()]

# Bi-Mode Branch Predictor
class O3_ARM_Neoverse_N1_BP_512(BiModeBP):
...
class O3_ARM_Neoverse_N1_512(DerivO3CPU):
    ...
    fuPool = O3_ARM_Neoverse_N1_FUP_512()

    switched_out = False
    branchPred = O3_ARM_Neoverse_N1_BP_512()
