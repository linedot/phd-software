...
class O3_ARM_Neoverse_N1_ICache_256(Cache):
    tag_latency = 1
    data_latency = 1
    response_latency = 1
    mshrs = 8
...
class O3_ARM_Neoverse_N1_DCache_256(Cache):
    tag_latency = 3
    data_latency = 3
    response_latency = 1
    tgts_per_mshr = 16
...
class O3_ARM_Neoverse_N1_L2_256(Cache):
    tag_latency = 5
    data_latency = 5
    response_latency = 2 
    mshrs = 46  # (1)
...
class O3_ARM_Neoverse_N1_L3_256(L3Cache):
    tag_latency = 48 
    data_latency = 48
    response_latency = 16 
    assoc = 16 # (1)
...
class O3_ARM_Neoverse_N1_FP_256(FUDesc):
    ...
    opList = [ OpDesc(opClass='SimdAdd', opLat=2), # ASIMD arithmetic basis (add & sub)
               ...
               OpDesc(opClass='SimdReduceAlu', opLat=6), # SVE reduction, logical (andv)
...
class O3_ARM_Neoverse_N1_Simple_Int_256(FUDesc):
...
class O3_ARM_Neoverse_N1_Complex_Int_256(FUDesc):
...
class O3_ARM_Neoverse_N1_LoadStore_256(FUDesc):
...
class O3_ARM_Neoverse_N1_PredAlu_256(FUDesc):
    opList = [ OpDesc(opClass='SimdPredAlu')  ]
    count = 1

class O3_ARM_Neoverse_N1_FUP_256(FUPool):
    FUList = [O3_ARM_Neoverse_N1_Simple_Int_256(),
              O3_ARM_Neoverse_N1_Complex_Int_256(),
              O3_ARM_Neoverse_N1_LoadStore_256(),
              O3_ARM_Neoverse_N1_PredAlu_256(),
              O3_ARM_Neoverse_N1_FP_256()]

# Bi-Mode Branch Predictor
class O3_ARM_Neoverse_N1_BP_256(BiModeBP):
...
class O3_ARM_Neoverse_N1_256(DerivO3CPU):
    ...
    switched_out = False
    branchPred = O3_ARM_Neoverse_N1_BP_256()
